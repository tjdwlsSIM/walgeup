/* 월급노트 공통 스크립트 — 모든 계산기 페이지에서 사용하는 함수
   ...
   ★ 연도별 수치는 YEAR_DATA 한 곳에만 둔다.
     예전에 MIN_WAGE_2026 · UI_MAX_2026 · UI_MIN_2026 이라는 상수가 따로 있었는데,
     YEAR_DATA 와 값이 겹치면서 아무도 참조하지 않는 채로 남아 있었다.
     이런 사본은 한쪽만 갱신되며 조용히 어긋난다 — 실제로 국민연금 기준소득월액
...
/* 1일 상·하한액은 YEAR_DATA[연도].uiMax / uiMin 에만 둔다 (사본 금지) */
